...
<head>
  ...
  <link rel="stylesheet" href="Style/emakumeak.css">
  <link rel="icon" href="Irudiak/logonew.png" type="image/png">
</head>

<body class="bodytituloa">
<header>
    <h1><a href="indexbaz.html"><img src="Irudiak/logonew.png" width="160" height="160" alt="Mi foto" /></h1>
    <nav>
      <ul>
        <li class="menu"><a href="Albisteakbaz.html">Taldearen albisteak</a></li>
        <li><a href="#">Historia</a>
          <ul>
            <li class="menu"><a href="Klubhistoriabaz.html">Klubaren historia</a></li>
            <li class="menu"><a href="Tituloakbaz.html">Irabazitako tituluak</a></li>
          </ul>
        </li>
        <li><a href="#">Taldea</a>
           <ul>
            <li class="menu"><a href="gizonakbaz.php">Gizonak</a></li>
            <li class="menu"><a href="emakumeakbaz.php">Emakumeak</a></li>
            <li class="menu"><a href="sub18baz.php">Sub 18</a></li>
            <li class="menu"><a href="sub16baz.php">Sub 16</a></li>
          </ul>
        </li>
  ...
  <main class="main">
    ...
    <div class="columna">
      ...
      <div class="alineatu">
        ...
        <div class="contenido">
          <p>Miren Mendizabal<br><span class="azpikoa">Harroin</span></p>
        </div>

        <div class="espacio"></div>

        <div class="contenido">
          <p>Lorea Lopez<br><span class="azpikoa">Orpokotzaile</span></p>
        </div>

        <div class="espacio"></div>

        <div class="contenido">
          <p>Laura Perez<br><span class="azpikoa">Harroin</span></p>
        </div>
      ...
      <div class="columnabi">
        ...
        <div class="alineatu">
          ...
          <div class="contenido">
            <p>Ainara Sanchez<br><span class="azpikoa">Bigarren lerro</span></p>
          </div>

          <div class="espacio"></div>

          <div class="contenido">
            <p>Saioa Gutierrez<br><span class="azpikoa">Bigarren lerro</span></p>
          </div>

          <div class="espacio"></div>

          <div class="contenido">
            <p>Laura Zubizarreta<br><span class="azpikoa">Hirugarren lerro hegal</span></p>
          </div>
        ...
        <div class="columnabi">
          ...
          <div class="alineatu">
            ...
            <div class="contenido">
              <p>Mireia Garcia<br><span class="azpikoa">Hirugarren lerro hegal</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Irati Arriaga<br><span class="azpikoa">Hirugarren lerro erdiko</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Naiara Campero<br><span class="azpikoa">Uztartze-erdilari</span></p>
            </div>
        ...
        <div class="columnabi">
          ...
          <div class="alineatu">
            ...
            <div class="contenido">
              <p>Ianire Aizpuru<br><span class="azpikoa">Joko-zabaltzaile</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Haizea Balenciaga<br><span class="azpikoa">Hegal</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Belen Gurrutxaga<br><span class="azpikoa">Erdiko</span></p>
            </div>
        ...
        <div class="columnabi">
          ...
          <div class="alineatu">
            ...
            <div class="contenido">
              <p>Carla Elizondo<br><span class="azpikoa">Erdiko</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Lucia Garmendia<br><span class="azpikoa">Hegal</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Ainhoa Ibaiondo<br><span class="azpikoa">Atzelari</span></p>
            </div>
          </div>
        </div>
  </main>
  ...
  <main class="mainbi">
    ...
    <div class="columna">
      ...
      <div class="alineatu">
        ...
        <div class="contenido">
          <p>Luken Hernandez<br><span class="azpikoa">Entrenatzailea</span></p>
        </div>

        <div class="espacio"></div>

        <div class="contenido">
          <p>Mikel Telletxea <br><span class="azpikoa">Ordezkaria</span></p>
        </div>
      ...
      <div class="columnabi">
        ...
        <div class="alineatu">
          ...
          <div class="contenido">
            <p>Manolo Cuerva<br><span class="azpikoa">2. Entrenatzailea</span></p>
          </div>

          <div class="espacio"></div>

          <div class="contenido">
            <p>Maria Agirre<br><span class="azpikoa">Medikua</span></p>
          </div>
        ...
        <div class="columnabi">
          ...
          <div class="alineatu">
            ...
            <div class="contenido">
              <p>Mireia Rodrigo<br><span class="azpikoa">Prestatzaile fisikoa</span></p>
            </div>

            <div class="espacio"></div>

            <div class="contenido">
              <p>Jon Gonzalez<br><span class="azpikoa">Fisioterapeuta</span></p>
            </div>
        ...
        <main class="mainhiru">
          ...
          <table>
            ...
            <?php
              ...
              $sql = "SELECT * FROM Partidoa WHERE Txapelketa_Kod1 = 2 AND (Lokala = '$equipo' OR Bisitaria = '$equipo')";
              $result = $conn->query($sql);

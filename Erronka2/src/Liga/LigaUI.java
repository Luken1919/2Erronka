...
public class LigaUI {
    ...
    private void sortuGordeBotoia() {
        ...
        int kopurua= (int) comboBoxTaldeKop.getSelectedItem();
        String TxapelketaKod = (String) comboBoxTxapelketaKodeak.getSelectedItem();
        JTextField[] TaldeDatuak =  txtTaldeak;
        PartiduDatuak Partidua = new PartiduDatuak( kopurua, TxapelketaKod, TaldeDatuak);

        btnGorde = new JButton("Gorde");
        btnGorde.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                sqlManager.insertPartidoak(Partidua.getTaldeKop(), Partidua.getTxapelketaKodeak(), Partidua.getTaldeak());
            }
        });
